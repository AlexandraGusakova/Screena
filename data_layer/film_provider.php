...
//            var_dump($film);
        ...
        public static function getGenres(){
            ...
            $genres = DatabaseAccess::getGenres();
            // var_dump($genres);
            return $genres;
        }

        public static function getCinemas($city){
            $cinemas = new DatabaseAccess;
            $cinemas = DatabaseAccess::getCinemas($city);
            // var_dump($genres);
            return $cinemas;
        }

        public static function getCity(){
            $city = new DatabaseAccess;
            $city = DatabaseAccess::getCity();
            // var_dump($genres);
            return $city;
        }
    }
